...
import {
    createNotifyChannel, createNotifyTemplate, delNotifyChannel, delNotifyTemplate,
    getNotifyChannels, getNotifyLogs, getNotifyTemplates, testNotifySend, updateNotifyChannel, updateNotifyTemplate,
} from '@/api/notify.js'
